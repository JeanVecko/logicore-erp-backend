...
INSERT INTO "new_invoices" ("amountPaid", "companyId", "createdAt", "createdById", "customerId", "dueDate", "id", "issuedAt", "ref", "saleId", "status", "totalAmount", "updatedAt") SELECT "amountPaid", "companyId", "createdAt", "createdById", "customerId", "dueDate", "id", "issuedAt", "ref", "saleId", "status", "totalAmount", "updatedAt" FROM "invoices";
DROP TABLE "invoices";
